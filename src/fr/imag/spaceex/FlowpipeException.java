...
/** Exception for Flowpipe construction issues.
 **/

public class FlowpipeException extends RuntimeException
{
    /** Create a new FlowpipeException specifying the reason by a message.
     ** @param mes the message.
     **/
    public FlowpipeException(String mes)
    {
        super(mes);
    }
}
